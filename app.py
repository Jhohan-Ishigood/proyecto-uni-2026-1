                ...
                if esta_disponible:
                    ...
                    st.markdown(f"""
                        <div style="position:relative;">
                            <img src="{escapar_html(src_imagen_plato)}" style="width:100%; height:auto; max-height:280px; object-fit:contain; border-radius:12px 12px 0px 0px; box-shadow: 0px 4px 12px rgba(0,0,0,0.6); display:block; margin:0; padding:0; background:#1a1a1a;">
                        </div>
                    """, unsafe_allow_html=True)
